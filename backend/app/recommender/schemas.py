...
class StudyBlock(BaseModel):
    ...
    # Content to study
    review_material: str | None = Field(None, description="Summary or key points to review")
...
class StudyPlanResponse(BaseModel):
    ...
    next_review_date: datetime | None = Field(None, description="When to do next review")
...
class StudyPlanRequest(BaseModel):
    ...
    focus_topics: list[int] | None = Field(None, description="Optional: focus on specific topics")
