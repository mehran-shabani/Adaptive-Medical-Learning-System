...
from app.auth.schemas import OTPRequest, OTPVerify, TokenResponse, OTPResponse
...
async def request_otp(
    ...
    """
    otp_code, expiry_minutes = AuthService.generate_and_send_otp(
...
async def get_current_user_info(
    ...
    return {
        ...
        "note": "Use Bearer token in Authorization header"
    }
